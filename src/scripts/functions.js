const aboutMe = {
	...
	en: `
		...
		<p>Motivated by this new professional direction, I have dedicated myself to building a solid foundation in development technologies. I have fundamental knowledge in C# (.NET), Python, TypeScript, JavaScript (Node.js), HTML, CSS, and databases such as SQLite and MySQL. In addition, my fluency in English and previous experience as a technical interface with international teams and clients allow me to collaborate effectively in diverse environments.</p>
